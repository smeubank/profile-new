...
- Maintain standardized Go To Market (GTM) documents for release tracking and marketing coordination.
    - [View GTM Documents](https://www.notion.so/793c0894f8af467884a6dfac903b9d94?pvs=21)
...
- June 25, 2024 [State of Platforms](https://www.notion.so/State-of-Platforms-99478e90ea8e4814aeec0dc1c32b83ec?pvs=21)
- this was way to verbose, if we do another at the half year it should be massively summarized and sped up

### Hackweek

- I did a hackweek with the team to help with onboarding and took over more of recording and editing etc ¯\*(ツ)*/¯

## Collaboration and Mentorship

- June 2024: Supported interns through data-driven guidance and hands-on planning.
    - NestJS SDK and metrics for sentry-cli
- Nuxt/Vue/UnJS Encouraged outreach to maintainers for better collaboration and promotion of SDK improvements.
- Facilitated team dynamics and cohesion through organized activities such as padel games and running clubs.
- Marketing and Sales, as described in detail above. Listed deliverables below
- Blogs and events:
    1. **[Blog]** March 28, 2024: Supabase Integration - [Blog](https://blog.sentry.io/monitor-supabase-databases-and-edge-functions/)
    2. **[Video]** March 2024: [Launch Week] Making Debugging Fun (Maybe) - [Video](https://www.youtube.com/watch?v=P5nUDIuMM94)
    3. **[Blog]** June 27, 2024: JavaScript SDK v8 Release - [Blog](https://blog.sentry.io/sentry-javascript-v8-sdk-otel-and-node-support/)
    4. **[Video]** October 2024: Fix Your Front-End: JavaScript Edition - [Workshop](https://www.youtube.com/watch?v=8EniI6prrzs)
    5. **[Changelog]** August 9, 2024: Turso Integration - [Changelog](https://sentry.io/changelog/turso--sentry-trace-slow-queries-and-capture-sqlite-errors/)
    6. **[Blog]** August 13, 2024: Twilio Integration - [Blog](https://blog.sentry.io/monitoring-twilios-flex-agent-desktop-with-sentry/)
- Conferences worked:
...
- Docs here [Competitor Product Donut Dives](https://www.notion.so/Competitor-Product-Donut-Dives-3ce6349105a042b79ad16dd1096053f9?pvs=21)
...
- Nuxt and Vue [notion docs](https://www.notion.so/70bb8caf18204f02adeb204485e49f73?pvs=21) have the most content and include the codeccov tests
